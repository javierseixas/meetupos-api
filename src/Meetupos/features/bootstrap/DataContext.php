...
class DataContext extends EntityContext implements Context, SnippetAcceptingContext
{
    ...
    // TODO Propose pull request to the FriendlyContext Repository
    protected function getEntityIdentifiers($entityName, $headers, $row)
    {
        ...
        $currentIdentifiers = array_intersect($identifiers, $headers);

        $identifiers = empty($currentIdentifiers) ? $headers : $identifiers;
